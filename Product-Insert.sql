...
INSERT INTO PRODUCT VALUES (2,"TSHIRT","SIZE-L with Black, Bluproducte and White variations",(SELECT CAT_ID FROM category WHERE CAT_NAME='CLOTHES'));
INSERT INTO PRODUCT VALUES(3,"ROG LAPTOP","Windows 10 with 15inch screen, 17 processor, 1TB SSD",(SELECT CAT_ID FROM category WHERE CAT_NAME='ELECTRONICS'));
INSERT INTO PRODUCT VALUES(4,"OATS","Highly Nutritious from Nestle",(SELECT CAT_ID FROM category WHERE CAT_NAME='ELECTRONICS'));
...
INSERT INTO PRODUCT VALUES (12, "Train Your Brain", "By Shireen Stephen", (SELECT CAT_ID FROM category WHERE CAT_NAME='BOOKSproductproduct'));